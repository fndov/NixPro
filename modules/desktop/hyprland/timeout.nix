{ pkgs, settings, ... }: {
  home-manager.users.${settings.account.name} = {
    ...
    services.hypridle.settings.general.before_sleep_cmd = "pid hyprlock || hyprlock --immediate";
    services.hypridle.settings.general.after_sleep_cmd = "hyprctl dispatch dpms on";
