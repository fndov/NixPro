{
  ...
  outputs = inputs@{ ... }: let
    settings = {
      ...
      driver.graphics = "nvidia"; # intel for virtual-machines.
      driver.intelBusID = "PCI:0:2:0";
      driver.nvidiaBusID = "PCI:9:0:0";
      system.version = "25.11";
      system.architecture = "x86_64-linux";
      system.init = "systemd-boot";
      system.bootMode = "uefi"; # bios default for vm, uefi modern standard.
      ...
      system.tag = "tommy";
      account.name = "miyu";
      account.email = "tommybice1@gmail.com";
      ...
      desktop.type = "gnome"; # null for no desktop, 'gnome' 'hyprland' 'plasma' and more.
      ...
      desktop.wallpaperMonitor = "eDP-1"; # eDP-1 for laptop display, Virtual-1 for vm.
